...
- Filled in a large batch of missing Bandcamp/YouTube/Spotify links for artists already known from other festivals.
...
- Fixed 3 combined acts (Originz & Rajax, Green Nuns Of The Revolution by Dick Trevor, Etnica & Pleiadians) so all members now open their own bio page.
...
- Improved several artist bios with more detail from their own SoundCloud pages, and fixed two incorrect SoundCloud links.
...
- Fixed the "Surprise Set" slot incorrectly showing a country, genre, and label that didn't belong to it. It now clearly shows "Surprise set! No info released yet."
...
- Fixed 2 collab acts ("Originz & Rajax", "Etnica & Pleiadians") that were showing as one plain block of text instead of separate, tappable artist entries.
...
- Simplified the wording on the old-app restore screen.
...
- New: an interactive festival site map — a detailed view and an overview, with a legend.
- Cleaned up and improved artist descriptions across the lineup.

## Version 1.0.0 — July 2026

- Browse the full Sizigia lineup across every stage and day — as a grid, a list, or stage rows.
...
- Bring your favorites over from the previous Sizigia app.
